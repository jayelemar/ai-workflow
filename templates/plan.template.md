...
- Architectural fallback: <specific isolation, allowlist, closed-form enforcement, or redesign to use if one root-cause family remains blocking in two fresh rounds | `N/A: LOW has no independent review rounds`>
